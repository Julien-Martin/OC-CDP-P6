                ...
                <v-layout row>
                    <v-flex xs12 md6>
                        ...
                        <v-select v-if="itemArg.paymentCondition || itemArg.state === 'DRAFT'"
                                  ...
                                  v-model="itemArg.paymentCondition" return-object :items="paymentCondition"
                                  label="Condition de paiement" class="mb-0">
                    ...
                    <v-layout row wrap>
                        <v-flex xs12 md6>
                            ...
                            <v-textarea v-if="itemArg.footNote || itemArg.state === 'DRAFT'"
                                        :disabled="itemArg.state !== 'DRAFT'" label="Informations supplémentaires"
                                        no-resize
