<template>
    <div>
        ...
        <Modal :visibility="modal.visiblity" :message="modal.message" v-on:cancel="modal.visiblity = $event"
        ...
        <v-container fluid>
            <v-toolbar dark color="primary" class="mb-2 hidden-print-only">
                ...
                <v-toolbar-items>
                    ...
                    <v-btn icon v-if="selectedItem.id !== 0 && selectedItem.state !== 'DRAFT'"
                           @click="print">
                        <v-icon>print</v-icon>
                    </v-btn>
